...
interface ShowClassicTerminalProps extends Pick<PreviewProps, 'previewMounted'> {
  cancelTests: () => void;
...
ShowClassicTerminal.displayName = 'ShowClassicTerminal';

export default connect(mapStateToProps, mapDispatchToProps)(ShowClassicTerminal);

export const query = graphql`
  query ClassicTerminalChallenge($slug: String!) {
